...
static void irkod_i_keeper__add(struct irkod_thing *it, struct irkod_node *node);
...
void irkod_i_keeper__add(struct irkod_thing *it, struct irkod_node *node)
{
	assert(it);
	assert(node);

	irkod_thing_attach(irkod_node_get_thing(node));
